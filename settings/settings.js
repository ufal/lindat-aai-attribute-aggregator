...
settings = {
    ...
    frontend: {
        ...
        howler: {
            ...
            'we would like to inform you that users from your home organisation tried to access protected\n'+
            'service(s) or resource(s) but were unable to do so because your Identity Provider has not released\n'+
            'all the mandatory attributes.\n\n'+
            'All the Service Providers in the CLARIN SPF are:\n'+
            '1) implementing the GEANT Data Protection Code of Conduct [2];\n'+
            ...
            'CLARIN SPF members. Please, see the recommendation from the DFN federation which attributes to\n'+
            ...
            'or see the CLARIN attribute profile described at\n'+
            ...
            '[2] http://hdl.handle.net/11346/GAIU\n'+
